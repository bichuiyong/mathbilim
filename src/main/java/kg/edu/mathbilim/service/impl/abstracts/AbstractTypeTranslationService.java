...
//        log.info("Saved translation for language {}: {}", saved.getId().getLanguageCode(), saved.getTranslation());
...
//        E saved = repository.save(translation);
//        log.info("Updated translation for language {}: {}", languageCode, newTranslation);
//        return mapper.toDto(saved);
//    }
//
//    @Transactional
//    public D upsertTranslation(D dto) {
//        if (existsTranslation(dto.ge, dto.getLanguageCode())) {
